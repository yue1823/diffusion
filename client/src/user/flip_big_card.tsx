                    ...
                    <Row style={{position:"absolute",top:320 ,zIndex:2}}>
                        <Col span={24} >
                            <div style={{ width: 240, height: 120,borderRadius:6,position:"absolute",top:70,left:-115}}>
                                ...
                                {can_claim_ornot ?  <>
                                        {right_or_wrong  ?
                                            <span style={{position: "relative", top: -370, left: -90}}>  <NotificationBoxes
                                                right={right_or_wrong} price={win_price} expire_or_not={can_claim_ornot}/></span>
                                            :
                                            <span style={{position: "relative", top: -370, left: -376}}>  <NotificationBoxes
                                                right={right_or_wrong} price={win_price} expire_or_not={can_claim_ornot} /></span>}
                                    </>
                                    :
                                    <>
                                        ...
                                        <span style={{backgroundColor:"hsl(0, 0%, 50%,0.9)",width:400,height:80,borderRadius:8,position:"relative",top:-210}}>
                                          <CountdownTimer expiredDate={result_data.save_data1.expired_time}/>
                                        </span>
                                    </>
                                }
