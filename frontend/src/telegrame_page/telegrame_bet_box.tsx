        ...
        <>
            ...
            >
                <Box sx={{width: "43vmax", height: "77vmax", backgroundColor: "#dffff6",borderRadius:5}} className={""}>
                    ...
                    <p style={{position:"absolute",left:"20vmax",top:"9.4vmax" ,fontSize:23 ,color:"rgba(100,98,98,0.8)"}}>Balance : {balance} APT</p>
                    <div style={{border:"solid 1px",width:"40vmax",height:1,position:"relative",left:"1.5vmax",top:"1.5vmax",borderColor:"rgba(100,98,98,0.3)"}}></div>
                    <br/>
                    <Row>
                        <Col span={9} offset={1} >
                    ...
                    <br/>
                    <Row gutter={[24,24]} style={{position:"relative",right:"0.4vmax"}}>
                        <Col span={5} offset={2}>
                            <button className={"rainbow"} style={{width: "10vmax", height: "15vmax"}} onClick={()=>{
                                set_transactiom_data({
