...
const Flip_card_big:React.FC<{result_data:Result_Data,profile_data:Profile,random_url:string}> = ({result_data,profile_data,random_url,}) =>{
    ...
    const [firstPart, ddd] = result_data.save_data1.pair.pair_name.split(" vs ");
                    ...
                    <div className="card-front" style={{ position: 'absolute', backfaceVisibility: 'hidden' }}>
                        <figure>
                            ...
                            <figcaption
                                ...
                                <p style={{fontSize: 35,top:-5,position:"relative"}}>{thirdPart}</p>
                            </figcaption>
                            ...
                            <figcaption style={{
                                ...
                                top: 10,
                                borderRadius: 3
                            }}>{profile_data.save_icon.name}</figcaption>
