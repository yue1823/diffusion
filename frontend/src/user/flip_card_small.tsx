...
import  "../css_/flip_card_small.css";
interface SavePair {
    can_bet:boolean;
    expired_time: string;
    left: string;
        ...
        <>
            <div className="flip-card-container" style={{}}>
                <div className="flip-card" style={{}}>
                    ...
                    <div className="card-front" style={{  width:90,height:90}}>
                        <figure>
                            ...
                            <figcaption style={{fontSize: 5 ,position:"relative",right:-20,top:15,width:55,height:45}} >
                                <img alt={"1"} src={real_url} style={{width:"100%",height:"100%" ,borderRadius:1,right:2}}></img></figcaption>
                            <figcaption style={{fontSize: 5}}>{profile_data.save_icon.name}</figcaption>
                        </figure>
                        ...
                        <ul style={{
                            ...
                            <li style={{
                                ...
                                top: '20%',
                                position: 'relative'
                            }}>Pair name : <span style={{display:'inline-block', width: '60%', textAlign: 'right',position:"relative",right:"-7%"}}>
                            ...
                            <li style={{
                                ...
                                top: '20%',
                                position: 'relative'
                            }}>Bet Amount: <span style={{display:'inline-block', width: '40%', textAlign: 'right',position:"relative",right:"-25%"}}>
                                                                    {balance}
                                                                  </span></li>
                            <li style={{
                                width: '100%',
                                ...
                                top: '20%',
                                position: 'relative'
                            }}>Choose : <span style={{display:'inline-block', width: '40%', textAlign: 'right',position:"relative",right:"-35%"}}>
                                                                            {choose}
                                                                          </span></li>
                            <li style={{
                                width: '100%',
                                ...
                                style={{display:'inline-block', width: '40%', textAlign: 'right',position:"relative",right:"-20%"}}>
                                                {expired_data}
                                              </span>
                            </li>
                        </ul>
...
export default Flip_card_small;