import {
  ...
  useCacheToken,
  useStyleRegister
} from "./chunk-ZDR5OM6F.js";
import {
  _toConsumableArray,
  init_toConsumableArray
} from "./chunk-QFVYZK5G.js";
import {
  BarsOutlined_default,
  Context_default,
  LeftOutlined_default,
  RightOutlined_default
} from "./chunk-6VIXFCFX.js";
import {
  TinyColor,
  _objectSpread2,
  canUseDom,
  ...
  useMemo,
  warning_default
} from "./chunk-7FQPJUF2.js";
import {
  require_classnames
} from "./chunk-DB6MYWSB.js";
import {
  require_react_is
} from "./chunk-DINUV27N.js";
import {
  require_react
...
var SiderContext = React15.createContext({});
...
var Sider = React15.forwardRef((props, ref) => {
  const {
  ...
  const {
    siderHook
  } = (0, import_react8.useContext)(LayoutContext);
  const [collapsed, setCollapsed] = (0, import_react8.useState)("collapsed" in props ? props.collapsed : defaultCollapsed);
  const [below, setBelow] = (0, import_react8.useState)(false);
  ...
  const responsiveHandlerRef = (0, import_react8.useRef)();
  ...
  const renderSider = () => {
    ...
    const zeroWidthTrigger = parseFloat(String(collapsedWidth || 0)) === 0 ? React15.createElement("span", {
      onClick: toggle,
    ...
    }, trigger || React15.createElement(BarsOutlined_default, null)) : null;
    const iconObj = {
      expanded: reverseArrow ? React15.createElement(RightOutlined_default, null) : React15.createElement(LeftOutlined_default, null),
      collapsed: reverseArrow ? React15.createElement(LeftOutlined_default, null) : React15.createElement(RightOutlined_default, null)
    };
    const status = collapsed ? "collapsed" : "expanded";
    const defaultTrigger = iconObj[status];
    const triggerDom = trigger !== null ? zeroWidthTrigger || React15.createElement("div", {
    ...
    return React15.createElement("aside", Object.assign({
      className: siderCls
    }, divProps, {
      style: divStyle,
      ref
  ...
  return React15.createElement(SiderContext.Provider, {
    value: contextValue
  }, renderSider());
});
if (true) {
...
function generator(_ref) {
  ...
  return (BasicComponent) => {
    const Adapter = React16.forwardRef((props, ref) => React16.createElement(BasicComponent, Object.assign({
      ref,
      suffixCls,
      tagName
    }, props)));
...
var Basic = React16.forwardRef((props, ref) => {
  const {
    prefixCls: customizePrefixCls,
    suffixCls,
    className,
  ...
  return wrapSSR(React16.createElement(TagName, Object.assign({
    className: (0, import_classnames2.default)(customizePrefixCls || prefixWithSuffixCls, className, hashId, cssVarCls),
    ref
  }, others)));
});
var BasicLayout = React16.forwardRef((props, ref) => {
  const {
    direction
  } = React16.useContext(ConfigContext);
  const [siders, setSiders] = React16.useState([]);
  const {
    prefixCls: customizePrefixCls,
    className,
    rootClassName,
  ...
  return wrapCSSVar(React16.createElement(LayoutContext.Provider, {
    value: contextValue
  }, React16.createElement(Tag, Object.assign({
    ref,
...
//# sourceMappingURL=chunk-UVWR65UL.js.map
