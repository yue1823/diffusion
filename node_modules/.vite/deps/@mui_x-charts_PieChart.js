...
import {
  ...
  useTheme
} from "./chunk-ISVMNYVZ.js";
import "./chunk-XUVRCOY5.js";
import "./chunk-MG42NVLU.js";
import {
  clsx_default
...
// node_modules/@mui/x-charts/esm/context/CartesianProvider/zoom.js
...
var ZAxisContext = React22.createContext({
  zAxis: {},
  zAxisIds: []
});
if (true) {
...
function ZAxisContextProvider(props) {
  ...
  const zAxis = React22.useMemo(() => inZAxis == null ? void 0 : inZAxis.map((axisConfig) => {
...
function useHighlighted() {
  const {
    isInitialized,
    data
  } = React29.useContext(HighlightedContext);
  if (!isInitialized) {
...
var useDefaultizeAxis = (inXAxis, inYAxis, dataset) => {
  const xAxis = React30.useMemo(() => defaultizeAxis(inXAxis, dataset, "x"), [inXAxis, dataset]);
  const yAxis = React30.useMemo(() => defaultizeAxis(inYAxis, dataset, "y"), [inYAxis, dataset]);
  return [xAxis, yAxis];
};
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react9.forwardRef)((givenProps, givenRef) => {
    ...
    return React31.createElement(Component, { ...usedProps, ref });
  });
};
...
var SpringContext = ({
  ...
  const { Provider } = ctx;
  return React32.createElement(Provider, { value: props }, children);
};
...
function useMouseTracker() {
  const svgRef = useSvgRef();
  const [mousePosition, setMousePosition] = React42.useState(null);
  React42.useEffect(() => {
    const element = svgRef.current;
    if (element === null) {
      return () => {
...
function ContinuousColorLegend(props) {
  ...
  return (0, import_jsx_runtime26.jsxs)(React52.Fragment, {
...
function useTransformData(series) {
  ...
  const dataWithHighlight = React57.useMemo(() => data.map((item, itemIndex) => {
    const currentItem = {
      seriesId,
      dataIndex: itemIndex
    };
...
function PiePlot(props) {
  ...
  const {
    ...
    width,
    height
  } = React61.useContext(DrawingContext);
...
var _excluded18 = ["xAxis", "yAxis", "series", "width", "height", "margin", "colors", "sx", "tooltip", "axisHighlight", "skipAnimation", "legend", "topAxis", "leftAxis", "rightAxis", "bottomAxis", "children", "slots", "slotProps", "onItemClick", "loading", "highlightedItem", "onHighlightChange", "className"];
var defaultMargin = {
  top: 5,
  bottom: 5,
  left: 5,
...
var PieChart = React65.forwardRef(function PieChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    series,
