 ...
 */
export type ExtractStructGenericArgsType<T extends ABIRoot, TStructName extends ResourceStructName<T>> = ConvertGenerics<ExtractStructMoveGenericArgsType<T, TStructName>>;
/**
 * Internal
 */
...
type ExtractStruct<T extends ABIRoot, TResourceName extends ResourceStructName<T>> = Extract<Struct<T>, {
    name: TResourceName;
}>;
...
type ExtractStructMoveGenericArgsType<T extends ABIRoot, TStructName extends ResourceStructName<T>> = ExtractStruct<T, TStructName>['generic_type_params'];
export {};
//# sourceMappingURL=structExtractor.d.ts.map